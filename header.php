...
<html lang="en">
  <head>
    ...
    <!-- CDN VERSIONS -->    
    <script type="https://code.jquery.com/jquery-2.1.0.min.js"></script>
    <script type="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
      ...
      <div class="container">
        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <a class="brand" href="<? echo get_bloginfo('wpurl'); ?>"><?php echo get_bloginfo( 'name' ); ?></a>
